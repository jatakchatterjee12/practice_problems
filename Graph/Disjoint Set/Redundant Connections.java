/*    
    MIK YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=EawxDEOxeIk
    Company Tags                 : Google
...
// S.C : O(n)
class Solution {
    boolean bfs(int start, int end, Map<Integer, List<Integer>> adj, int n){
    ...
    public int[] findRedundantConnection(int[][] edges) {
        ...
        for(int i = 0; i < n; i++){
            ...
            if(adj.containsKey(u) && adj.containsKey(v) && bfs(u, v, adj, n)){
                return edges[i];
            }
