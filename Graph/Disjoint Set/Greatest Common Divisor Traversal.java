/*
    codeStorywithMIK YOUTUBE    : https://www.youtube.com/watch?v=TI-xIXH4EnE
    Company Tags                : GOOGLE
...
public:
    bool canTraverseAllPairs(vector<int>& nums) {
        ...
        vector<int> first(m+1, -1); // instead of using map<int, int> factor2Index 
...
class Solution {
    public boolean canTraverseAllPairs(int[] nums) {
        ...
        int[] first = new int[m + 1]; //Map<Integer, Integer> factor2Index
        Arrays.fill(first, -1);
