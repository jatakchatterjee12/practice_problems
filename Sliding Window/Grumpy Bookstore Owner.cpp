...
/***************************************************************** JAVA ******************************************************************************/
//Approach - Sliding Window --> calculate the max Unsatified customers sum within the mintues range and then apply the power onto that.
//T.C : O(n)
//S.C : O(1)
class Solution {
    public int maxSatisfied(int[] customers, int[] grumpy, int minutes) {
        ...
        int totalCustomers = maxUnsat; // using the power
